...
export const DAY_MERGIN_BETWEEN = 8
export const DAY_SIZE = (Dimensions.get('screen').width / WEEK_DAYS) - (SCREEN_HORIZONTAL_PADDING + 5) 

interface Props extends TouchableOpacityProps {
    amountOfHabits?:number
    amouthOfCompleted?: number
    date: Date
}

export function HabitDay({ amountOfHabits = 0, amouthOfCompleted = 0, date,...rest}: Props){

    const amountAccomplishedPercentage = amountOfHabits > 0 ? generateProgressPercentage(amountOfHabits, amouthOfCompleted) : 0
